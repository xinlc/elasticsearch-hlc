 ...
 * @since 2021-03-27
 */
public interface IEsPage<T> extends Iterable<T> {
     ...
     * @return 分页
     */
    static <T> IEsPage<T> of(long total, List<T> content, IEsPageable pageable) {
        return new EsPageImpl<>(total, content, pageable);
    }
